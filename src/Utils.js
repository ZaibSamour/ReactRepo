export const blogs_list = [
  ...
  // {
  //   id: 3,
  //   title: "What Is Entanglement and Why Is It Important?",
  //   detail:
  ...
  },
  {
    userId: 1,
    id: 9,
    title: "Mesciunt iure omnis dolorem tempora et accusantium",
...
export const getPostId = (id) => {
  return blogs_list.find((obj) => obj.id == id);
};

// export const deletePost = (id) => {
//   console.log("Id :", id);
//   console.log("Index of id :", id - 1);
//   return blogs_list.filter((blog) => blog.id !== id);
//   // return blogs_list.find((obj) => {
//   //   if (obj.id == id) {
//   //     blogs_list.filter(id);
//   //   }
//   // });
// };
